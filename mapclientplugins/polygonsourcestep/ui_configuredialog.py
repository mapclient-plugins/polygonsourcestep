...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.fileFormatLabel)

        self.fileFormatCombo = QComboBox(self.configGroupBox)
        self.fileFormatCombo.setObjectName(u"fileFormatCombo")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.fileFormatCombo)
